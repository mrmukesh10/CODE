"""
MobileNetV2 - Single Image Prediction
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-dir', default=r'D:\project\mobilenetv2\results', help='Output directory for results')
    args = parser.parse_args()

    print('\n' + '='*60)
    print('  MobileNetV2 - SINGLE IMAGE PREDICTION')
    print('='*60)
