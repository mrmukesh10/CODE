"""
DenseNet201 - Single Image Prediction
...
def predict_single_image(model_path, image_path, class_names_path, output_dir=None):
    ...
    # Display results
    print('\n' + '='*60)
    print('PREDICTION RESULTS - DenseNet201')
    print('='*60)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default=r'D:\project\models\best_densenet201.keras', help='Model path')
    parser.add_argument('--class-names', default=r'D:\project\models\class_names.json', help='Class names JSON')
    parser.add_argument('--output-dir', default=r'D:\project\densenet201\results', help='Output directory for results')
    args = parser.parse_args()

    print('\n' + '='*60)
    print('  DenseNet201 - SINGLE IMAGE PREDICTION')
    print('='*60)
